...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/tu-mera-dusman/BABY-EXTRA-PLUGIN", 
)
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/tu-mera-dusman/babymusic",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/Nonsecularowner"
)  # Example:- https://t.me/INNOCENT_NOBITA_FIGHTER
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/meradad"
)  # Example:- https://t.me/INNOCENT_NOBITA_FIGHTER
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/INNOCENT_NOBITA_FIGHTER")
...
if PING_IMG_URL:
    if PING_IMG_URL != "https://envs.sh/jfD.jpg":
...
if PLAYLIST_IMG_URL:
    if PLAYLIST_IMG_URL != "https://envs.sh/jfD.jpg":
...
if GLOBAL_IMG_URL:
    if GLOBAL_IMG_URL != "https://envs.sh/jfD.jpg":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "https://envs.sh/jfD.jpg":
...
if TELEGRAM_AUDIO_URL:
    if TELEGRAM_AUDIO_URL != "https://envs.sh/jfD.jpg":
...
if STREAM_IMG_URL:
    if STREAM_IMG_URL != "https://envs.sh/jfD.jpg":
...
if SOUNCLOUD_IMG_URL:
    if SOUNCLOUD_IMG_URL != "https://envs.sh/jfD.jpg":
...
if YOUTUBE_IMG_URL:
    if YOUTUBE_IMG_URL != "https://envs.sh/jfD.jpg":
...
if TELEGRAM_VIDEO_URL:
    if TELEGRAM_VIDEO_URL != "https://envs.sh/jfD.jpg":
